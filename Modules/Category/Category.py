...
class Ui_Category(object):
    def setupUi(self, Category):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Category.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Home/Icon_Transaction.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_CATEGORY.setGeometry(QtCore.QRect(246, 9, 127, 34))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight")
        ...
        self.Icon_mybalance.setGeometry(QtCore.QRect(280, 70, 70, 70))
        ...
        self.lineEdit_mybalance.setGeometry(QtCore.QRect(370, 100, 120, 32))
        self.lineEdit_mybalance.setObjectName("lineEdit_mybalance")
        self.label_mybalance = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_mybalance.setGeometry(QtCore.QRect(370, 70, 108, 20))
        ...
        self.Icon_income.setGeometry(QtCore.QRect(531, 70, 70, 70))
        ...
        self.lineEdit_expense.setGeometry(QtCore.QRect(879, 100, 117, 32))
        ...
        self.label_expense.setGeometry(QtCore.QRect(879, 70, 108, 20))
        ...
        self.Icon_expense.setGeometry(QtCore.QRect(791, 70, 70, 70))
        ...
        self.lineEdit_income.setGeometry(QtCore.QRect(624, 100, 117, 32))
        ...
        self.label_income.setGeometry(QtCore.QRect(624, 70, 108, 20))
        ...
        self.label.setGeometry(QtCore.QRect(242, 142, 810, 91))
        ...
        self.radioButton_food.setGeometry(QtCore.QRect(309, 151, 73, 50))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Food.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.radioButton_transport.setGeometry(QtCore.QRect(386, 151, 73, 50))
        ...
        self.label_2.setGeometry(QtCore.QRect(316, 210, 41, 14))
        font = QtGui.QFont()
...
"color: rgb(9, 48, 48);")
        ...
        self.label_3.setGeometry(QtCore.QRect(381, 210, 71, 14))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.radioButton_medicine.setGeometry(QtCore.QRect(463, 151, 73, 50))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Medicine.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_9.setGeometry(QtCore.QRect(464, 210, 64, 16))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.radioButton_groceries.setGeometry(QtCore.QRect(541, 151, 73, 50))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Groceries.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_10.setGeometry(QtCore.QRect(541, 210, 69, 16))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.radioButton_rent.setGeometry(QtCore.QRect(619, 151, 73, 50))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Rent.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_11.setGeometry(QtCore.QRect(639, 211, 35, 16))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.radioButton_gifts.setGeometry(QtCore.QRect(699, 151, 73, 50))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Gifts.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_12.setGeometry(QtCore.QRect(711, 210, 32, 16))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.radioButton_saving.setGeometry(QtCore.QRect(781, 151, 73, 50))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Saving.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_13.setGeometry(QtCore.QRect(782, 210, 47, 16))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.radioButton_entertainment.setGeometry(QtCore.QRect(861, 151, 73, 50))
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Icon_Entertainment.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_14.setGeometry(QtCore.QRect(843, 210, 100, 16))
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(11)
...
"color: rgb(9, 48, 48);")
        ...
        self.groupBox.setGeometry(QtCore.QRect(250, 240, 451, 331))
...
"background-color: rgb(85, 170, 255);")
        ...
        self.pushButton_addexpenses = QtWidgets.QPushButton(parent=self.groupBox)
        self.pushButton_addexpenses.setGeometry(QtCore.QRect(130, 260, 180, 45))
        self.pushButton_addexpenses.setStyleSheet("background-color: rgb(231, 237, 255);")
        self.pushButton_addexpenses.setText("")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("D:\\Do_An_KTLT\\Modules\\Category\\../../Images/Category/Button_AddExpenses.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_addexpenses.setIcon(icon12)
